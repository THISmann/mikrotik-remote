class tagModifyAction extends ui {
    constructor() {
        super();
        this.multiplier = 1;
        ...
        <div class="p-1 bg-blue-100 rounded-md m-1">
            ...
            <div>    
                <div class="flex">
                    ...
                    <div class="my-9 mx-2">
                        <button id="@{_modifyActionRemove}" class="text-white hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
    ...
    Init() {
        this._modifyActionRemove.addEventListener('click', () => {
            this.SetData({remove: true});
        });
        
        // this._modifyActionSave.addEventListener('click', () => { 
        //     this.tagModifyAction = {
        //         "flags": this.flags,
        //         "multiplier": this.multiplier,
        //         "regEx": this.regEx
        //     }
        //     socket.emit('tagModifyAction', this.tagModifyAction);
        // });
